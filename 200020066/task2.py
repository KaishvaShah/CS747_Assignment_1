...
if __name__ == '__main__':
  ...
  # TASK 2A
  task2ap1s = [0.9]*19
  task2ap2s = [i * 0.05 for i in range(19)]
  regrets = task2(UCB, 30000, task2ap1s, task2ap2s)
  # print(regrets)
  plt.plot(task2ap2s, regrets)
  plt.title("Regret vs p2")
  plt.xlabel("Probability of second arm")
  plt.ylabel("Regret from UCB")
  plt.savefig("task2A-UCB.png")
  plt.clf()

  # TASK 2B
  task2bp2s = [i * 0.05 for i in range(19)]
  task2bp1s = [i + 0.1 for i in task2bp2s]
  regrets_ucb = task2(UCB, 30000, task2bp1s, task2bp2s)
  regrets_klucb = task2(KL_UCB, 30000, task2bp1s, task2bp2s)
  plt.plot(task2bp2s, regrets_ucb)
  plt.title("Regret vs p2")
  plt.xlabel("Probability of second arm")
  plt.ylabel("Regret from UCB")
  ...
  plt.plot(task2bp2s, regrets_klucb)
  plt.title("Regret vs p2")
  plt.xlabel("Probability of second arm")
  plt.ylabel("Regret from KL UCB")
  plt.savefig("task2B-KLUCB.png")
  plt.clf()
